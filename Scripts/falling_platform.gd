...
@onready var respawn_timer :=  $"respawn-timer" as Timer
...
func _on_anim_animation_finished(anim_name):
	...
	respawn_timer.start(reset_timer) # Replace with function body.
...
func _on_respawntimer_timeout():
	...
	is_triggered = false # Replace with function body.
